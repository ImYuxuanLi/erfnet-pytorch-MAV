# Main code for training ERFNet model in MAV dataset
# Jan 2021
# Yuxuan Li
#######################
...
class MyCoTransform(object):
    ...
    def __call__(self, input, target):
        ...
        target = Relabel(101, 0)(target)
        target = Relabel(201, 0)(target)
...
def train(args, model, enc=False):
    ...
    dataset_train = MAV(args.datadir, co_transform, 'train')
    dataset_val = MAV(args.datadir, co_transform_val, 'val')
    ...
    for epoch in range(start_epoch, args.num_epochs+1):
        ...
        #Validate on 154 val images after each epoch of training
